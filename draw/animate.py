...
case_name = 'pca'  # circle_case rand_case
# safety_weight = 0
...
plot_episode(obstacles_info, agents_info, traj_list, step_num_list, plot_save_dir=plot_save_dir,
             base_fig_name=base_fig_name, last_fig_name=last_fig_name, show=False)
